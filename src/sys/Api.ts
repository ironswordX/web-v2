...
export default async function Api() {
    window.tb = {
        ...
        launcher: {
            ...
            async removeApp(name: string) {
                ...
                const realName = String(name).replace(/[^a-zA-Z0-9]/g, '').toLowerCase();
        ...
        system: {
            ...
            users: {
                ...
                async add(user: User) {
                    ...
                    await Filer.fs.promises.writeFile(`/apps/user/${username}/files/config.json`, JSON.stringify({
                        "quick-center": true,
                        "sidebar-width": 180,
                        "drives": {
                    ...
                    await Filer.fs.promises.writeFile(`/apps/user/${username}/files/quick-center.json`, JSON.stringify({
                        "paths": {
    ...
    if (window.loadLock) // this function seems to be called twice, anura doesn't like initing twice, so well, this is the weird fix I chose instead of tackling the root problem - Rafflesia
        return;
        ...
        let anura = await Anura.new({
            ...
            "x86": {"debian":{"bzimage":"/images/debian-boot/vmlinuz-6.1.0-11-686","initrd":"/images/debian-boot/initrd.img-6.1.0-11-686","rootfs":["images/debian-rootfs/aa","images/debian-rootfs/ab","images/debian-rootfs/ac","images/debian-rootfs/ad","images/debian-rootfs/ae","images/debian-rootfs/af","images/debian-rootfs/ag","images/debian-rootfs/ah","images/debian-rootfs/ai","images/debian-rootfs/aj","images/debian-rootfs/ak","images/debian-rootfs/al","images/debian-rootfs/am","images/debian-rootfs/an","images/debian-rootfs/ao","images/debian-rootfs/ap","images/debian-rootfs/aq","images/debian-rootfs/ar","images/debian-rootfs/as","images/debian-rootfs/at","images/debian-rootfs/au","images/debian-rootfs/av","images/debian-rootfs/aw","images/debian-rootfs/ax","images/debian-rootfs/ay","images/debian-rootfs/az","images/debian-rootfs/ba","images/debian-rootfs/bb","images/debian-rootfs/bc","images/debian-rootfs/bd","images/debian-rootfs/be","images/debian-rootfs/bf","images/debian-rootfs/bg","images/debian-rootfs/bh","images/debian-rootfs/bi","images/debian-rootfs/bj","images/debian-rootfs/bk","images/debian-rootfs/bl","images/debian-rootfs/bm","images/debian-rootfs/bn","images/debian-rootfs/bo"]},},
        });
        window.anura = anura;
